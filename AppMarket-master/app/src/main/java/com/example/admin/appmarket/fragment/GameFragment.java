...
public class GameFragment extends BaseFragment {
    ...
    public View onSuccessedView() {
        ...
        listView.setAdapter(new GameFragment.MyAdapter(mAppInfoList, listView));
        return listView;
    }
    ...
    public LoadingPage.ResultState onLoad() {
        ...
        mAppInfoList = appProtocol.getGameDataFromNet(0);
    ...
    class MyAdapter extends MyBaseAdapter{
        ...
        public List onLoadMore() {
            AppProtocol appProtocol = new AppProtocol();
            List<AppInfo> moreData = appProtocol.getGameDataFromNet(0);
            return moreData;
        }
