...
public class HomeDetailActivity extends BaseActivity {
    ...
    private View onCreateSuccessedView() {
        ...
        int REQUEST_PERMISSION_CODE = 2;
            ...
            if (ActivityCompat.checkSelfPermission(HomeDetailActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(HomeDetailActivity.this, PERMISSIONS_STORAGE, REQUEST_PERMISSION_CODE);
            }
    ...
    private LoadingPage.ResultState onLoad() {
        ...
        mData = detailProtocol.getAppDataFromNet(0);
