    ...
    private class DownloadTask implements Runnable{
        ...
        public void run() {
            ...
            if(!file.exists() //没下载过
                    ...
                    try {
                        Log.d(TAG,downloadInfo.getDownloadUrl());
            ...
            if(httpResult==null){
                Log.d(TAG,"httpResult is null");
            }
            if((inputStream=httpResult.getInputStream())==null){
                Log.d(TAG,"httpResult inputStream is null");
            }
